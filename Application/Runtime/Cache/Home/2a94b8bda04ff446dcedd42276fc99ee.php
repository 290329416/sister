...
<body>
   ...
   <div class="header">
      <div class="logo"><span><img src="/Public/home/images/logo_03_1.png"></span><h2>中国电子商务协会<br/>质量促进工作委员会</h2></div>
      <div class="search">
   ...
   <div class="main">
	   <style>
		...
		.news_left ul li{border: 2px solid #d5d5d5;font-size: 14px;text-align:center;line-height:40px;margin:10px 0px;border-radius:10px;}
		.news{float:left;margin:0px 10px;}
		.news_right{width: 150px;float:right;}
		.news_right ul li{border: 2px solid #d5d5d5;font-size: 14px;text-align:center;line-height:40px;margin:10px 0px;border-radius:10px;}
	   </style>
		<div class='news_one'>
		<div class='news_left'>
			<ul>
		...
		<div class='news_right'>
			<ul>
				<li style='margin-top:0px;'><a href=''>企业资质查询</a></li>
