					...
					<div class="col-xs-12">
						...
						<div class="table-responsive">
							...
							<tbody aria-relevant="all" aria-live="polite" role="alert">
								<form action="<?php echo U('News/delete');?>" id='myform' method='post'>
								<?php if(is_array($new)): foreach($new as $key=>$new): ?><tr class="odd">
										<td class="center">
											<label>
												<input type="checkbox" name='id[]' class="ace" value="<?php echo ($new["id"]); ?>" />
												<span class="lbl"></span>
											</label>
										</td>
										<td class="">
							...
							<div class="row">
								<div class="col-sm-6">
									<div id="sample-table-2_info" class="dataTables_info"><button type="button" class="btn btn-info" id="bootbox-confirm">批量删除</button>&nbsp;&nbsp;&nbsp;共<?php echo ($count); ?>条数据&nbsp;&nbsp;&nbsp;总页数&nbsp;<?php echo ($num); ?></div>
								</div>
								<div class="col-sm-6">
