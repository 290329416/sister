			...
			<div class="col-xs-12">
				...
				<form action="" method="post" name='myform' role="form" class="form-horizontal" onsubmit="return doCheck()">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" class="col-xs-10 col-sm-5" name='name' placeholder="栏目名称" id="form-field-1" value="<?php echo ($res["name"]); ?>"/>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" class="col-xs-10 col-sm-5" name='namepath' placeholder="栏目路径名称" id="form-field-1" value="<?php echo ($res["namepath"]); ?>"/>
							<span class="help-inline col-xs-12 col-sm-7">
