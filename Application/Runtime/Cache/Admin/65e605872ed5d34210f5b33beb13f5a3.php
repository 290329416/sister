...
<div class="main-content">
	<div id="breadcrumbs" class="breadcrumbs">
		...
		<ul class="breadcrumb">
			...
			<li>
				<a href="/sister/admin_china.php/user/index">查看所有用户</a>
			</li>
		</ul><!-- .breadcrumb -->
	</div>
						...
						<div class="table-responsive">
										...
										<div class="col-sm-6">
											<div id="sample-table-2_length" class="dataTables_length">
												<div class="dataTables_filter" id="sample-table-2_filter">
													<form action="/sister/admin_china.php/User/index" method='post'>
							...
							<tbody role="alert" aria-live="polite" aria-relevant="all">
								...
								<?php if(is_array($users)): foreach($users as $key=>$user): ?><tr class="odd">
										<td class="">
											<a href="/sister/admin_china.php/User/show/id/<?php echo ($user["id"]); ?>"><?php echo ($user["username"]); ?></a>
										</td>
										...
										<td class=" ">
											<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
												<a href="/sister/admin_china.php/User/show/id/<?php echo ($user["id"]); ?>" class="blue" title='查看详情'>
													<i class="icon-zoom-in bigger-130"></i>
													查看
												</a>

												<a href="/sister/admin_china.php/User/update/id/<?php echo ($user["id"]); ?>" class="green" title='修改信息'>
...
function delfun(userid){
	if(confirm("确认删除本数据?")){
		window.location.href='/sister/admin_china.php/User/delete/id/'+userid;
	}
}
</script>
